...
int main(void)
{
	...
	GPIO_setupDirection(PORTA_ID,PIN3_ID,PIN_INPUT); /* PA3 Input Pin */
	GPIO_setupDirection(PORTA_ID,PIN4_ID,PIN_INPUT); /* PA4 Input Pin */
	...
	while(1)
	{
		...
		{
			/*if pressed toggle all Even LEDS*/
